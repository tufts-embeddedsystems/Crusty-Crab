// Minimal code example to connect to WiFi.
...
// Sorting for AP scan, either `WIFI_CONNECT_AP_BY_SIGNAL` or `..._BY_SECURITY`
#define EXAMPLE_WIFI_CONNECT_AP_SORT_METHOD WIFI_CONNECT_AP_BY_SIGNAL

// Lower limits of what to accept in the scan
#define CONFIG_EXAMPLE_WIFI_SCAN_RSSI_THRESHOLD -100
